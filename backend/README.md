...
## Project Structure
    ...
    ├── testapiautoconnecto_96570  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_96570`
...
2. Clone this repo and `cd testapiautoconnecto_96570`
